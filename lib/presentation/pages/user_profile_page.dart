...
class _UserProfilePageState extends ConsumerState<UserProfilePage> {
  ...
  Widget build(BuildContext context) {
    ...
    if (isMe) {
       Future.microtask(() {
         if (mounted && GoRouterState.of(context).uri.path != '/myspace') {
           context.go('/myspace');
         }
       });
    ...
    if (videosState.items.isNotEmpty) {
    ...
    return Scaffold(
      body: NestedScrollView(
        ...
        headerSliverBuilder: (context, innerBoxIsScrolled) {
          return [
            SliverAppBar(
              expandedHeight: 350.0, // Height for header
              pinned: true,
              leading: IconButton(
                            ...
                            onPressed: () {
                              ...
                              if (isFollowing) {
                                ...
                                final dummyVideo = Video(
                                  ...
                                  creatorId: widget.userId, creatorName: displayName, category: '', tags: [], 
                                  viewCount: 0, likeCount: 0, createdAt: DateTime.now()
                                );
